...
(load-file "C:/Documents and Settings/Kostafey/Application Data/.emacs.d/cedet-1.0pre6/common/cedet.el")
(global-set-key [?\C- ] 'semantic-ia-complete-symbol)

;; ECB
(add-to-list 'load-path "C:/Documents and Settings/Kostafey/Application Data/.emacs.d/ecb-2.32/") 
(require 'ecb)
(global-set-key (kbd "\e\el") 'ecb-toggle-ecb-windows)
(global-set-key (kbd "C-x C-a") 'ecb-activate)
(global-set-key (kbd "C-x C-d") 'ecb-deactivate)
...
;(setq global-semantic-auto-parse-mode 1)
...
;; Боевая раскраска
(add-to-list 'load-path "~/.emacs.d/color-theme-6.6.0/")  ;;указываем где будут лежать файлы расширений
